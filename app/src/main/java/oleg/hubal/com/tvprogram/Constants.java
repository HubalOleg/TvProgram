...
public class Constants {
    public static final String URL =                    "https://t2dev.firebaseio.com/";
    public static final String CATEGORY_JSON =          "CATEGORY.json";
    public static final String CHANNEL_JSON =           "CHANNEL.json";
